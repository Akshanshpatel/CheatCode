...
export default function ToolBar({
  ...
  return (
    <section className="mt-10 mx-auto w-10/12 bg-[#2f3136] rounded-lg px-6 py-4 flex items-center justify-between">
      ...
      {/* Left part */}
      <div className="relative w-80 flex gap-10">
        <Search
          size={18}
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className="w-full pl-10 py-2 rounded bg-[#202225] text-white focus:outline-none"
        />
  ...
  {/* Image */}
          <img src="/superman.svg" className={`relative h-fit w-30 cursor-pointer transition-opacity duration-200
  ...
  <img
    src="/batman5.svg"
    className={`relative h-fit w-30 cursor-pointer transition-opacity duration-200
