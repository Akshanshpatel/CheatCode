...
const Systum = () => {
 ...
 <div className="mx-auto mt-10 w-8/12 mb-20 rounded-xl bg-[#2b2f33] overflow-hidden text-white">
  {/* Header */}
  <div className="grid grid-cols-2 px-10 py-4 font-semibold border-b border-neutral-600">
  ...
  ["Design Netflix", "Medium", "https://systemdesignschool.io/problems/netflix/solution"]
    ...
    <div
    key={idx}
    className="grid grid-cols-2 px-6 py-3 border-b border-neutral-700 last:border-none"
    >
      <a href={url} className='hover:text-blue-400 pl-20'>
      <span>{title}</span>
      </a>
      <span
